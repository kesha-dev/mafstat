...
namespace backend\components\contenttools\assets;
...
class ContentToolsImagesAsset extends AssetBundle
{
     ...
     * {@inheritdoc}
     */
    public $sourcePath = '@backend/components/contenttools/js';
     ...
     * {@inheritdoc}
     */
    public $depends = ['backend\components\contenttools\assets\ContentToolsAsset'];
}
