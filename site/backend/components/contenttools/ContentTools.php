...
namespace backend\components\contenttools;

use backend\components\contenttools\assets\ContentToolsAsset;
use backend\components\contenttools\assets\ContentToolsImagesAsset;
use backend\components\contenttools\assets\ContentToolsTranslationsAsset;
use Yii;
 ...
 * {
 *      return [
 *          'content-tools-image-upload' => \bizley\contenttools\actions\UploadAction::class,
 *          'content-tools-image-insert' => \bizley\contenttools\actions\InsertAction::class,
 *          'content-tools-image-rotate' => \bizley\contenttools\actions\RotateAction::class,
 *      ];
 * }
 * ~~~
 * 
